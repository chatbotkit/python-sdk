...
- Packaging only: releases are now published to PyPI through GitHub Actions
  Trusted Publishing (OIDC), replacing the previous API-token flow. There are no
  changes to the SDK's public API or behaviour since 0.5.0.
